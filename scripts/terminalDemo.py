...
python3 scripts/terminalDemo.py
"""
import sys
...
# TODO: Change this to the rows of the users you want to sample
...
def _create_user_row() -> pd.Series:
    ...
    # Simple 0–1 style scores: usage = average of normalized hours + opens (no videos question)
...
# ─────────────────────────────────────────────────────────────
# MAIN FLOW (UPDATED INTERACTIVE SYSTEM)
# ─────────────────────────────────────────────────────────────
